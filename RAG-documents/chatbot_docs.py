...
#from langchain_huggingface import HuggingFaceEndpoint #solucao alterativa
...
# Indexação e recuperação (versão com debug)
def config_retriever(uploads):
    print("DEBUG - Iniciando config_retriever...")
    ...
    try:
        ...
        print("DEBUG - Documentos carregados:", len(docs))

        # Split dos textos
        text_splitter = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=200)
        splits = text_splitter.split_documents(docs)
        print("DEBUG - Splits criados:", len(splits))
        ...
        print("DEBUG - Vetor store criado e salvo")
        ...
        print("ERRO em config_retriever:", e)
        return None
...
def config_rag_chain(model_class, retriever):
    ...
    print("DEBUG - Valor do retriever antes de criar a chain:", st.session_state.retriever)
